...
<body>
					...
					<div class="col-sm-6">
						<div class="contactinfo">
							<ul class="nav nav-pills">
								<li><a href=""><i class="fa fa-phone"></i> +01752853403</a></li>
								<li><a href=""><i class="fa fa-envelope"></i> nazmulhaquenpi@gmail.com</a></li>
							</ul>
						</div>
					</div>
					<div class="col-sm-6">
			...
			<div class="row">
				...
				<div class="col-sm-4">
					<div class="signup-form"><!--sign up form-->
						...
						<form action="{{url('/customer-registration')}}">
							<input type="text" placeholder="Name"/>
							<input type="email" placeholder="Email Address"/>
	...
	<footer id="footer"><!--Footer-->
		...
		<div class="footer-bottom">
			<div class="container">
				<div class="row">
					<p class="pull-left">Copyright © 2021 Online Shop  All rights reserved.</p>
