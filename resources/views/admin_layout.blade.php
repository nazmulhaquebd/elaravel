...
"><i class="halflings-icon off"></i> Logout</a></li>
			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li><a href="{{URL::to('/all-brands')}}"><i class="icon-eye-open"></i><span class="hidden-tablet"> All Brands</span></a></li>
						<li><a href="{{URL::to('/add-brands')}}"><i class="icon-dashboard"></i><span class="hidden-tablet"> Add Brands</span></a></li>
						...
						<li>
							...
							<ul>
								<li><a class="submenu" href="{{URL::to('/all-products')}}"><i class="icon-file-alt"></i><span class="hidden-tablet"> All Products</span></a></li>
	...
	<footer>
		...
		<p>
			<span style="text-align:left;float:left">&copy; 2020 <a href="http://jiji262.github.io/Bootstrap_Metro_Dashboard/" alt="Bootstrap_Metro_Dashboard">Online Shop Dashboard</a></span>
