...
<body>
                    ...
                    <div class="col-sm-6">
                        <div class="contactinfo">
                            <ul class="nav nav-pills">
                                <li><a href="#"><i class="fa fa-phone"></i> +880 1752853403</a></li>
        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                foreach($all_published_slider as $value){
                    ...
                    <?php } ?>
                            <div class="col-sm-3">
                                <h1><span>{{ $value->slider_name }}</span></h1>
                                <h2>{{ $value->slider_tittle }}</h2>
                                <p>{{ $value->slider_description }}</p>
                                <button type="button" class="btn btn-default get">Get it now</button>
                            </div>
                            <div class="col-sm-9">
                                <img src="{{ $value->slider_image }}" class="girl img-responsive" alt="" style="width:720px; height:370px;"/>
                            </div>
                        </div>
                <?php $i++; } ?>
                    </div>
                      ...
                      foreach ($show_all_catagory as $value) { ?>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h4 class="panel-title"><a href="{{URL::to('/category_with_products',$value->category_id)}}">{{$value->category_name}}</a></h4>
                            </div>
                        </div>
                   <?php } ?>
                    ...
                    ->where('brands_status',1)
                     ->get();
                      ...
                      foreach ($show_all_brands as $value){?>
                        ...
                        <div class="brands-name">
                            <ul class="nav nav-pills nav-stacked">
                                <li><a href="{{URL::to('/brands_with_products',$value->brands_id)}}"> <span class="pull-right">{{$value->brands_description}}</span>{{$value->brands_name}}</a></li>
                            </ul>
                        </div>
            <?php } ?>
    ...
    <footer id="footer"><!--Footer-->
        ...
        <div class="footer-bottom">
            <div class="container">
                <div class="row">
                    <p class="pull-left">Copyright © 2020 Online Shop. All rights reserved.</p>
                    <p class="pull-right">Designed by <span><a target="_blank" href="https://www.facebook.com/softitInstitute">Nazmul</a></span></p>
                </div>
            </div>
        </div>
