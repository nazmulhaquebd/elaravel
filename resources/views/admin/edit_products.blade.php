			...
			<form class="form-horizontal" action="{{url('/update-products',$all_products_infos->products_id)}}" method="post" enctype="multipart/form-data">
			  ...
			  <fieldset>
				...
				<div class="control-group hidden-phone">
				  ...
				  <div class="controls">
					<textarea class="cleditor" id="textarea2" rows="3" name="products_short_description" required>{{$all_products_infos->products_short_description}}</textarea>
				  </div>
				</div>
				<div class="control-group hidden-phone">
				...
				<div class="control-group">
				  ...
				  <div class="controls">
					<input type="text" class="input-xlarge" id="date01" name="products_price" value="{{$all_products_infos->products_price}}" required>
				  </div>
				</div>
				  <div class="control-group">
					<label class="control-label">Products Image</label>
					<div class="controls">
						<input type="file" class="input-xlarge" id="date01" value="{{$all_products_infos->products_image}}" name="products_image" required>
					</div>
				  </div>
				  <div class="control-group">
				...
				<div class="control-group">
				  ...
				  <div class="controls">
					<input type="text" class="input-xlarge" id="date01" name="products_color" value="{{$all_products_infos->products_color}}" required>
				  </div>
				</div>
				<div class="control-group">
