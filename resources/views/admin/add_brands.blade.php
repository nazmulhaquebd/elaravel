...
@section('admin_content')
		...
		?>
					...
					<div class="box-content">
						<form class="form-horizontal" action="{{url('/save-brands')}}"method="post">
							{{csrf_field()}}
						  <fieldset>
							...
							<div class="control-group">
							  ...
							  <div class="controls">
								<input type="text" class="input-xlarge " id="date01" name=" brands_name"required>
							  </div>
							</div> 
							<div class="control-group hidden-phone">
							  <label class="control-label" for="textarea2">Brands description</label>
							  <div class="controls">
								<textarea class="cleditor" id="textarea2" rows="3"name="brands_description"required></textarea>
							  </div>
							</div>
							<div class="control-group">
